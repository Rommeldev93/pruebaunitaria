...
class EmpleadoServiceImplTest {
  ...
  void insertTest() {
    //GIVEN
    Empleado e = new Empleado(username, "nombre", "apell", 1500);

    //WHEN
    when(daoMock.save(e)).thenReturn(e);
    Empleado rdo = serviceMock.insert(e);
  ...
  void modificarTest() {
    //GIVEN
    //Empleado e1= new Empleado(username, "nombre", "apell", 1500);
    Empleado e2 = new Empleado(username, "nombre", "apell", 3500);
  ...
  void buscarPorUsernameTest() {
    //GIVEN
    Empleado e = new Empleado(username, "nombre", "apell", 3500);
  ...
  void eliminarTest() {
    //GIVEN
    Empleado e = new Empleado(username, "nombre", "apell", 3500);
    Optional<Empleado> opt = Optional.ofNullable(null);

    //WHEN
    //Buscar por cualquier String->ArgumentMatchers sino devuelve opt que es null
    when(daoMock.findById(ArgumentMatchers.anyString())).thenReturn(opt);
  ...
  void buscarTodosTest() {
    //GIVEN
    Empleado e1 = new Empleado(username + "1", "nombre", "apell", 3500);
    Empleado e2 = new Empleado(username + "2", "nombre2", "apell", 500);
